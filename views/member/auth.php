       ...
       <section class="section sign-in inner-right-xs"> 
        ...
        <form role="form" class="login-form cf-style-1"> 
         ...
         <div class="field-row clearfix"> 
          <span class="pull-left"> <label class="content-color"><input type="checkbox" class="le-checbox auto-width inline" /> <span class="bold">记住我</span></label> </span> 
          <span class="pull-right"> <a href="#" class="content-color bold">忘记密码 ?</a> </span> 
         </div> 
