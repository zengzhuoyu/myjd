    ...
    <div class="container"> 
     <div class="col-xs-12 col-sm-4 col-md-3 sidemenu-holder"> 
      ...
      <div class="side-menu animate-dropdown"> 
       <div class="head">
        <i class="fa fa-list"></i> 所有分类 
       </div> 
       <nav class="yamm megamenu-horizontal" role="navigation"> 
        <ul class="nav"> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">电子产品</a> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">服装类</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">玩具类</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">智能家居</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">厨房厨具</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">家居装潢</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">生鲜水果</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">床上用品</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
         ...
         <!-- /.menu-item --> 
         <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">书籍</a> 
          <ul class="dropdown-menu mega-menu"> 
           <li class="yamm-content"> 
            <!--  MEGAMENU VERTICAL  --> 
            <div class="row"> 
        ...
        <div class="item" style="background-image: url(assets/images/sliders/slider03.jpg);"> 
         <div class="container-fluid"> 
          <div class="caption vertical-center text-left"> 
           <div class="big-text fadeInDown-1">
             想获得
            <span class="big"><span class="sign">￥</span>200</span>的优惠？ 
           </div> 
           <div class="excerpt fadeInDown-2">
             速速前来 
            <br />快速抢购
    ...
    <div class="container"> 
     <div class="col-xs-12 col-lg-6 no-margin banner"> 
      <a href="category-grid.html"> 
       ...
       </div> <img class="banner-image" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/banner-narrow-01.jpg" /> </a> 
     </div> 
     <div class="col-xs-12 col-lg-6 no-margin text-right banner"> 
      <a href="category-grid.html"> 
       ...
       </div> <img class="banner-image" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/banner-narrow-02.jpg" /> </a> 
     </div> 
    </div>
    <!-- /.container --> 
   </section>
      ...
      <div class="tab-content"> 
       <div class="tab-pane active" id="featured"> 
        ...
        <div class="loadmore-holder text-center"> 
         <a class="btn-loadmore" href="#"> <i class="fa fa-plus"></i> 查看更多</a> 
        </div> 
       </div> 
       ...
       <div class="product-item-holder size-big single-product-gallery small-gallery"> 
        <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel"> 
         <div class="single-product-gallery-item" id="slide1"> 
          <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg"> <img alt="" src="assets/images/blank.gif" data-echo="assets/images/products/product-gallery-01.jpg" /> </a> 
         </div>
     ...
     <div class="carousel-holder"> 
      ...
      <div id="owl-brands" class="owl-carousel brands-carousel"> 
       <div class="carousel-item"> 
        <a href="#"> <img alt="" src="assets/images/brands/brand-01.jpg" /> </a> 
       </div>
       <!-- /.carousel-item --> 
       <div class="carousel-item"> 
        <a href="#"> <img alt="" src="assets/images/brands/brand-02.jpg" /> </a> 
       </div>
       <!-- /.carousel-item --> 
       <div class="carousel-item"> 
        <a href="#"> <img alt="" src="assets/images/brands/brand-03.jpg" /> </a> 
       </div>
       <!-- /.carousel-item --> 
       <div class="carousel-item"> 
        <a href="#"> <img alt="" src="assets/images/brands/brand-04.jpg" /> </a> 
       </div>
       <!-- /.carousel-item --> 
       <div class="carousel-item"> 
        <a href="#"> <img alt="" src="assets/images/brands/brand-01.jpg" /> </a> 
